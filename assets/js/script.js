// Clears local storage if there are more than ten cities saved on page load
...
//Loads saved buttons from local storage if there are any to load
    ...
    .then((data) => {
      ...
      fetch(weatherQueryURL)
        ...
        .then((data) => {
          ...
          // TODAY'S FORECAST pulls data into appropriate display location
          ...
          // TOMORROW'S FORECAST and the next four days do the same thing as above: weather data gets put in show weather places
          ...
          if (localStorage.length === 0) {
            ...
            var foundMatch = true;
            // ... and creates a new button to search for that stored city
            newButton();
